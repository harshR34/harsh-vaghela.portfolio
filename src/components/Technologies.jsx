import { RiReactjsLine, RiJavaFill, RiNodejsFill, RiJavascriptLine } from "react-icons/ri";
import { SiMysql, SiPython, SiPhp, SiExpress, SiMongodb, SiDjango, SiSqlite } from "react-icons/si";
        ...
        <div className="border-b border-neutral-800 pb-24">
            ...
            className="flex flex-wrap items-center justify-center gap-4">
                ...
                <motion.div
                    ...
                    animate='animate'
                    className='rounded-xl border-4 border-neutral-800 p-4'>
                    <SiDjango className="text-7xl bg-custom-green rounded-2xl p-2" />
                </motion.div>
                <motion.div
                    variants={iconVariants(4)}
                    initial='initial'
